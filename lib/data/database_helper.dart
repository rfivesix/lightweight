...
class DatabaseHelper {
  ...
  Future<void> _createDB(Database db, int version) async {
    ...
    await db.execute('CREATE TABLE supplement_logs ('
        'id INTEGER PRIMARY KEY AUTOINCREMENT,'
        ...
        ')' // <-- KEIN Komma vor der schließenden Klammer
        );
    ...
    print("Benutzer-DB (v13) neu erstellt.");
  }
...
// Upgrade auf Version 13: Indizes nachziehen
    ...
    if (oldVersion < 14) {
      await db.execute('CREATE TABLE IF NOT EXISTS meals ('
          ...
          'updated_at TEXT'
          ')');
      await db.execute('CREATE TABLE IF NOT EXISTS meal_items ('
          'id INTEGER PRIMARY KEY AUTOINCREMENT,'
          'meal_id INTEGER NOT NULL,'
          'barcode TEXT NOT NULL,'
          'quantity_in_grams INTEGER NOT NULL,'
      ...
      await db.execute(
          'CREATE INDEX IF NOT EXISTS idx_meal_items_meal_id ON meal_items(meal_id)');
      print("DB v14: meals & meal_items erstellt.");
    }
  }
